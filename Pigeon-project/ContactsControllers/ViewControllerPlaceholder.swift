...
//  Pigeon-project
//
//  Created by Chase Brignac after 11/6/17.
...
class ViewControllerPlaceholder: UIView {
  ...
  let contactsAuthorizationDeniedtitle = "PopTrainer doesn't have access to your contacts"
  let contactsAuthorizationDeniedSubtitle = "Please go to your iPhone Settings –– Privacy –– Contacts. Then select ON for PopTrainer."
  
  let emptyFalconUsersTitle = "No PopTrainer users in your contacts yet."
  let emptyFalconUsersSubtitle = "You can invite your friends to PopTrainer at the Contacts tab  "
