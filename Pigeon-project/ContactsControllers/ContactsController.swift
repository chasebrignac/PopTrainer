...
class ContactsController: UITableViewController {
 ...
 fileprivate func presentSettingsActionSheet() {
    let alert = UIAlertController(title: "Permission to Contacts", message: "PopTrainer uses phone numbers as unique identifiers, so that it is easy for you to switch from other messaging apps and retain your social graph. We store your contacts in order to find your friends. We only need the number and name (first and last) for this to work and store no other data about your contacts.", preferredStyle: .actionSheet)
