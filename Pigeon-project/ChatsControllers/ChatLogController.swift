...
//    }
 ...
 var refreshControl: UIRefreshControl = {
    ...
    if currentReachabilityStatus != .notReachable {
      ...
      if inputContainerView.inputTextView.text != "" {
        let properties = ["text": inputContainerView.inputTextView.text!]
          //maybe I can call a new rootview controller and make an object then call this function
          //print("Debug only intercept text message data")
          //print(inputContainerView.inputTextView.text)
  ...
  func sendMessageWithProperties(_ properties: [String: AnyObject]) {
    ...
    // just call this method to send a message sendMessageWithProperties(["text": Cya])
